...
//  private Task task;
  ...
  private Activity(String userName, Action action, Entity entity) {
  ...
  public static Activity create(String userName, Action action, Entity entity) {
    return new Activity(userName, action, entity);
  }
