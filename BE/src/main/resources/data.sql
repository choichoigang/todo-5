...
insert into user (id, name, password, project, project_key) values (1, 'jypthemiracle', 'codesquad', 1, 0);
...
insert into task (id, title, content, category, category_key, user, author) values (1, 'study java', 'i love javajigi', 1, 0, 1, 'jypthemiracle');